    ...
    <>
      <div className="flex gap-4 w-full">
        <Button
          ...
          className="flex-1 shrink gap-2.5 rounded-lg p-3.5 hover:bg-white/10 bg-white/5 text-white cursor-pointer h-auto border-none ring-0 shadow-none"
        >
          Sign In
          <svg
            width="23"
        ...
        <Button
          ...
          className="flex-1 shrink gap-2.5 rounded-lg p-3.5 text-white hover:bg-white/10 bg-white/5 cursor-pointer h-auto border-none ring-0 shadow-none"
        >
          Sign In
          <svg
            width="22"
