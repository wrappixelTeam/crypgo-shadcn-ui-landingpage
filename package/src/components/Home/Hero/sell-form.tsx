  ...
  return (
    <div className="max-w-md mx-auto p-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Button className="hover:text-background font-medium text-lg bg-transparent w-full border border-primary rounded-lg py-6 text-primary hover:bg-primary transition-all duration-300">
          Sell
        </Button>
      </form>
    </div>
